...
; (function (window) {
    ...
    function ReadingTime(numberWordsPerMinute, readigTimeLabel, minutesLabel, wordsLabel, lessThanAMinuteLabel) {
        ...
        const paragraphs = document.querySelectorAll('.articleshow__article--body p');
        ...
        if (readingTimeDuration > 0) {
            if (readingTimeSeconds > 30) {
                ...
                document.querySelector(".readTime").innerHTML = readingTimeDuration + ' ' + minutesLabel;
            } 
            document.querySelector(".readTime").innerHTML = readingTimeDuration + ' ' + minutesLabel;
        } else {
            document.querySelector(".readTime").innerHTML = lessThanAMinuteLabel;
        }
    }
